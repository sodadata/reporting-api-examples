...
class SnowflakeCredentials:
    account: str = config("account", default="")
    user: str = config("user", default="")
    password: str = config("password", default="")
    database: str = config("database", default="")
    schema: str = config("schema", default="")
    warehouse: str = config("warehouse", default="")


@dataclass
class ApiAuth:
    soda_username: str = config("soda_username")
    soda_password: str = config("soda_password")
